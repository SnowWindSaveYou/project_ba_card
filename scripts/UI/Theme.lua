...
-- 牌桌（柔和的中蓝灰色调，提亮避免灰蒙蒙）
Theme.TABLE_SURFACE  = Color(0.32, 0.38, 0.55, 1.0)   -- 中蓝灰桌面（与BattleGrid idle一致）
Theme.TABLE_WOOD     = Color(0.40, 0.46, 0.62, 1.0)   -- 蓝灰边框（稍亮）
Theme.TABLE_GILT     = Color(0.65, 0.80, 1.00, 1.0)   -- 浅蓝高光线条（更亮）
